...
INSERT INTO Party (name) SELECT DISTINCT Rawdata2014.party FROM Rawdata2014;
INSERT INTO Ward (name, electorate) SELECT DISTINCT Rawdata2014.ward, Rawdata2014.electorate FROM Rawdata2014;
INSERT INTO Candidate (name, party, ward, votes) SELECT DISTINCT Rawdata2014.candidate, Party.id, Ward.id,
Rawdata2014.votes FROM Rawdata2014 INNER JOIN (Party, Ward) ON (Rawdata2014.party = Party.name AND
Rawdata2014.ward = Ward.name);
